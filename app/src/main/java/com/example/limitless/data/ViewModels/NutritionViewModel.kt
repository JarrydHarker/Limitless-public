...
class NutritionViewModel(val currentDate: LocalDate = LocalDate.now() , var calorieWallet: Double = currentUser!!.GetCalorieWallet(), var ratio: Ratios = currentUser!!.ratios): ViewModel() {
